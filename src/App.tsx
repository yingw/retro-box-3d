...
function GameBox({ textureSet, groupRef }: { textureSet: string, groupRef: React.MutableRefObject<THREE.Group> }) {
...
function Rotator({ group1, group2 }: { group1: React.MutableRefObject<THREE.Group>, group2: React.MutableRefObject<THREE.Group> }) {
